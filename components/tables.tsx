  ...
  const formBody = (
    <>
      ...
      <FormControl mb={4} mt={4}>
        ...
        >
          {materials.map((mat) => (
            <option key={shortid.generate()} value={mat}>
              {mat}
            </option>
          ))}
        </Select>
      ...
      <FormControl mb={4} mt={4}>
        ...
        <Select value={type} variant="flushed" onChange={handleType(setType)}>
          {types.map((tp) => (
            <option key={shortid.generate()} value={tp}>
              {tp}
            </option>
          ))}
        </Select>
      ...
      <FormControl mb={4} mt={4}>
        ...
        >
          {qualities.map((q) => (
            <option key={shortid.generate()} value={q}>
              {q}
            </option>
          ))}
        </Select>
  ...
  return (
    <>
      <Table size="sm" variant="striped" colorScheme="teal">
        <TableCaption fontSize="3xl" placement="top">
          <Flex
          ...
          >
            ...
            <BasicIconModal
              data={{
                ...
                funcToRun: () => {
                  resetAll();
                  createFunc(name, material, type, quality);
                },
              }}
            />
          </Flex>
                ...
                <Td>
                  <BasicIconModal
                    data={{
                      ...
                      funcToRun: () => {
                        editFunc(row.id, name, material, type, quality);
                      },
                    }}
                  />
                  <Tooltip
